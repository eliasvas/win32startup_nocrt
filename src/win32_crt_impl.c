//Credit : mmozeiko~https://hero.handmade.network/forums/code-discussion/t/94-guide_-_how_to_avoid_c_c++_runtime_on_windows#530
...
#define FREE(x) (VirtualFree(x, sizeof(*x), MEM_RELEASE))
//TODO: fix this shit
#define REALLOC(x, new_size) ALLOC(new_size)
